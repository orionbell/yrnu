...
fn is_v6_test() {
    ...
    assert_eq!(
        IpVersion::is_v6("ffee:0000:1234:4321:feed:dead:c0ff:eeee"),
        true
    );
    assert_eq!(
        IpVersion::is_v6("ffee:0000:1234:4321:feed:dead:c0ff:rrrr"),
        false
    );
...
fn expend_shorten_test() {
    assert_eq!(
        IpAddress::expend("f01:0:1:20:300::10").unwrap(),
        "0f01:0000:0001:0020:0300:0000:0000:0010".to_string()
    );
    assert_eq!(
        IpAddress::shorten("0f01:0000:0001:0020:0300:0000:0000:0010").unwrap(),
        "f01:0:1:20:300::10".to_string()
    );
    assert_eq!(
        IpAddress::expend("0f01:0:0001:020:0300::0010").unwrap(),
        "0f01:0000:0001:0020:0300:0000:0000:0010".to_string()
    );
    assert_eq!(
        IpAddress::shorten("0f01:00:0001:0020:0300::0010").unwrap(),
        "f01:0:1:20:300::10".to_string()
    );
}
//#[test]
...
fn eui64_test() {
    ...
    assert_eq!(
        ...
        "fe80::a8bb:ccff:feee:ff11"
    );
    assert_eq!(
        IpAddress::eui64(&mac2).to_string(),
        "fe80::1322:33ff:fe44:5566"
    );
    assert_eq!(
        IpAddress::eui64(&mac3).to_string(),
        "fe80::1034:56ff:fe78:9acd"
    );
}
